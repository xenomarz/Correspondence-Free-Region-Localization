#include <objective_functions/symmetric_dirichlet_old.h>

SymmetricDirichletOld::SymmetricDirichletOld()
{
    name = "symmetric dirichlet old";
}

void SymmetricDirichletOld::init()
{
...
void SymmetricDirichletOld::updateX(const VectorXd& X)
{
...
void SymmetricDirichletOld::setVF(MatrixXd& V, MatrixX3i& F) {
...
double SymmetricDirichletOld::value(bool update)
{
...
void SymmetricDirichletOld::gradient(VectorXd& g)
{
...
void SymmetricDirichletOld::hessian()
{
    UpdateSSVDFunction();
...
bool SymmetricDirichletOld::updateJ(const VectorXd& X)
{
...
void SymmetricDirichletOld::UpdateSSVDFunction()
{
	#pragma omp parallel for num_threads(24)
...
void SymmetricDirichletOld::ComputeDenseSSVDDerivatives()
{
...
inline Matrix6d SymmetricDirichletOld::ComputeFaceConeHessian(const Vector6d& A1, const Vector6d& A2, double a1x, double a2x)
{
...
inline Matrix6d SymmetricDirichletOld::ComputeConvexConcaveFaceHessian(const Vector6d& a1, const Vector6d& a2, const Vector6d& b1, const Vector6d& b2, double aY, double bY, double cY, double dY, const Vector6d& dSi, const Vector6d& dsi, double gradfS, double gradfs, double HS, double Hs)
{
...
void SymmetricDirichletOld::prepare_hessian()
{
	II.clear();
	JJ.clear();

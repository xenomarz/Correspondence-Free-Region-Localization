...
CoordinateDataProvider::CoordinateDataProvider(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const RDS::VertexIndex vertex_index, CoordinateType coordinate_type) :

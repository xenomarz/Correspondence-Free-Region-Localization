//#pragma once
//#ifndef OPTIMIZATION_LIB_FACE_VERTICES_POSITION_OBJECTIVE_H
//#define OPTIMIZATION_LIB_FACE_VERTICES_POSITION_OBJECTIVE_H
//
//// STL includes
//#include <vector>
//
...
//class FaceVerticesPositionObjective : public FacePositionObjective<StorageOrder_>
//{
//public:
//	/**
//	 * Constructors and destructor
//	 */
//	FaceVerticesPositionObjective(const std::shared_ptr<PlainDataProvider>& plain_data_provider, const std::vector<std::pair<RDS::VertexIndex, Eigen::Vector2d>>& index_vertex_pairs) :
//		FacePositionObjective(plain_data_provider, "Vertex Position Objective", index_vertex_pairs.size()),
...
//	}
//
//	virtual ~FaceVerticesPositionObjective()
//	{
//
//	}
//
//	void MoveFacePosition(const Eigen::Vector2d& offset) override
//	{

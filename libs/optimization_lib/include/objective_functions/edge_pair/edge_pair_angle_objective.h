...
public:
	 ...
	 */
	EdgePairAngleObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::pair<int64_t, int64_t>& edge1_indices, const std::pair<int64_t, int64_t>& edge2_indices, bool enforce_psd = true) :
		PeriodicObjective(mesh_data_provider, "Edge Pair Angle Objective", M_PI / 2, 8, enforce_psd),

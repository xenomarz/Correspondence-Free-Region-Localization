...
//	 */
//	enum class VertexNumber : int32_t
//	{
//		Vertex1,
//		Vertex2
//	};
//
//	enum class VertexCoordinate : int32_t
//	{
//		X,
//		Y
//	};
...
//	 */
//	EdgePairTranslationObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::shared_ptr<EdgePairDataProvider>& edge_pair_data_provider, const VertexNumber vertex_number, const VertexCoordinate vertex_coordinate, const bool enforce_psd = false) :
...
//		vertex_coordinate_(vertex_coordinate)
//	{
//		this->Initialize();
//	}
//
...
//	const VertexNumber vertex_number_;
//	const VertexCoordinate vertex_coordinate_;
//};
//
//#endif
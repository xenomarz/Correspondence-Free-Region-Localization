...
//class EdgePairLengthObjective : public SparseObjectiveFunction<StorageOrder_>
//{
//public:
//	/**
//	 * Constructors and destructor
//	 */
//	EdgePairLengthObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::pair<uint64_t, uint64_t>& edge1_indices, const std::pair<uint64_t, uint64_t>& edge2_indices, bool enforce_psd = true) :
//		SparseObjectiveFunction(mesh_data_provider, "Edge Pair Angle Objective", M_PI / 2, 8, enforce_psd),
...
//
//		sparse_index_to_first_derivative_value_map_[Partial::E1_V1_X] = e1_y_to_e1_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E1_V1_Y] = e1_x_to_e1_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E1_V2_X] = e1_y_to_e1_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E1_V2_Y] = e1_x_to_e1_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E2_V1_X] = e2_y_to_e2_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E2_V1_Y] = e2_x_to_e2_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E2_V2_X] = e2_y_to_e2_squared_norm;
//		sparse_index_to_first_derivative_value_map_[Partial::E2_V2_Y] = e2_x_to_e2_squared_norm;
//
...
//
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E1_V1_X }] = e1_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E1_V1_Y }] = -e1_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E1_V2_X }] = -e1_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E1_V2_Y }] = e1_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E2_V1_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E2_V1_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E2_V2_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_X, Partial::E2_V2_Y }] = 0;
//
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E1_V1_X }] = e1_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E1_V1_Y }] = e1_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E1_V2_X }] = -e1_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E1_V2_Y }] = -e1_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E2_V1_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E2_V1_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E2_V2_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E1_Y, Partial::E2_V2_Y }] = 0;
//
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E1_V1_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E1_V1_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E1_V2_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E1_V2_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E2_V1_X }] = e2_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E2_V1_Y }] = -e2_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E2_V2_X }] = -e2_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_X, Partial::E2_V2_Y }] = e2_squares_diff_prod_to_quad_norm;
//
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E1_V1_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E1_V1_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E1_V2_X }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E1_V2_Y }] = 0;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E2_V1_X }] = e2_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E2_V1_Y }] = e2_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E2_V2_X }] = -e2_squares_diff_prod_to_quad_norm;
//		vertex_index_sparse_index_to_second_derivative_value_map_[{ PartialCoordinateType::E2_Y, Partial::E2_V2_Y }] = -e2_diff_prod_to_quad_norm;
//	}
//
//private:
//	/**
...
//	std::unordered_map<Partial, double> sparse_index_to_first_derivative_sign_map_;
//	std::unordered_map<Partial, double> sparse_index_to_first_derivative_value_map_;
//	std::unordered_map<std::pair<PartialCoordinateType, Partial>, double, Utils::OrderedPairHash, Utils::OrderedPairEquals> vertex_index_sparse_index_to_second_derivative_value_map_;
//};
//
//#endif
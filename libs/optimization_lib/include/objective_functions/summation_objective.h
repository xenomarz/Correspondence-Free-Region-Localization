...
public:
	...
	SummationObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::vector<std::shared_ptr<ObjectiveFunctionType_>>& objective_functions, const std::string& name, const bool explicitly_zero_diagonal = false, const bool parallel_update = false) :
		SummationObjective(mesh_data_provider, name, explicitly_zero_diagonal, parallel_update)
	{
		AddObjectiveFunctions(objective_functions);
	}

	SummationObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::shared_ptr<ObjectiveFunctionType_> objective_function, const std::string& name, const bool explicitly_zero_diagonal = false, const bool parallel_update = false) :
		SummationObjective(mesh_data_provider, std::vector<std::shared_ptr<ObjectiveFunctionType_>>{ objective_function }, name, explicitly_zero_diagonal, parallel_update)
	{

	}

	SummationObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::vector<std::shared_ptr<ObjectiveFunctionType_>>& objective_functions, const bool explicitly_zero_diagonal = false, const bool parallel_update = false) :
		SummationObjective(mesh_data_provider, objective_functions, "Summation Objective", explicitly_zero_diagonal, parallel_update)
	{

	}

	SummationObjective(const std::shared_ptr<MeshDataProvider>& mesh_data_provider, const std::shared_ptr<ObjectiveFunctionType_> objective_function, const bool explicitly_zero_diagonal = false, const bool parallel_update = false) :
		SummationObjective(mesh_data_provider, objective_function, "Summation Objective", explicitly_zero_diagonal, parallel_update)
	{

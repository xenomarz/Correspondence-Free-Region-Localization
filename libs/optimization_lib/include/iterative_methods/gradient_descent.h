...
class GradientDescent : public IterativeMethod<StorageOrder>
{
public:
	GradientDescent::GradientDescent(std::shared_ptr<ObjectiveFunction<StorageOrder>> objective_function, const Eigen::VectorXd& x0) :

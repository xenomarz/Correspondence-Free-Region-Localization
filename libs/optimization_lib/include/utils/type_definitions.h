...
namespace RDS
{
	...
	{
		std::size_t operator () (const EdgePairDescriptor& edge_pair_descriptor) const
		{
			const auto edge_descriptor1 = static_cast<EdgeDescriptor>(edge_pair_descriptor.first);
			const auto edge_descriptor2 = static_cast<EdgeDescriptor>(edge_pair_descriptor.second);

			EdgeDescriptor minmax_edge_descriptor1 = std::minmax(edge_descriptor1.first, edge_descriptor1.second);
			EdgeDescriptor minmax_edge_descriptor2 = std::minmax(edge_descriptor2.first, edge_descriptor2.second);
	...
	struct EdgePairDescriptorEquals
	{
		...
		bool operator () (const EdgePairDescriptor& edge_pair_descriptor1, const EdgePairDescriptor& edge_pair_descriptor2) const
		{
			...
			const auto edge_descriptor2_1 = static_cast<EdgeDescriptor>(edge_pair_descriptor1.second);

			const auto edge_descriptor1_2 = static_cast<EdgeDescriptor>(edge_pair_descriptor2.first);
			const auto edge_descriptor2_2 = static_cast<EdgeDescriptor>(edge_pair_descriptor2.second);
			
			EdgeDescriptor minmax_edge_descriptor1_1 = std::minmax(edge_descriptor1_1.first, edge_descriptor1_1.second);
			EdgeDescriptor minmax_edge_descriptor2_1 = std::minmax(edge_descriptor2_1.first, edge_descriptor2_1.second);

			EdgeDescriptor minmax_edge_descriptor1_2 = std::minmax(edge_descriptor1_2.first, edge_descriptor1_2.second);
			EdgeDescriptor minmax_edge_descriptor2_2 = std::minmax(edge_descriptor2_2.first, edge_descriptor2_2.second);
	...
	{
		std::size_t operator () (const HessianEntry& hessian_entry) const
		{
	...
	{
		bool operator () (const HessianEntry& hessian_entry1, const HessianEntry& hessian_entry2) const
		{

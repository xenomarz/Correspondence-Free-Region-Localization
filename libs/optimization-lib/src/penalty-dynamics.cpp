...
PenaltyDynamics::PenaltyDynamics()
{
    name = "Objective: Symmetric Dirichlet";
}
void PenaltyDynamics::init()
{
...
void PenaltyDynamics::updateX(const VectorXd& X)
{
	bool inversions_exist = updateJ(X);
}

double PenaltyDynamics::value()
{
...
void PenaltyDynamics::gradient(VectorXd& g)
{
	UpdateSSVDFunction();
...
bool PenaltyDynamics::updateJ(const VectorXd& X)
{
...
void PenaltyDynamics::UpdateSSVDFunction()
{
...
void PenaltyDynamics::ComputeDenseSSVDDerivatives()
{
...
inline Matrix6d PenaltyDynamics::ComputeFaceConeHessian(const Vector6d& A1, const Vector6d& A2, double a1x, double a2x)
{
...
inline Matrix6d PenaltyDynamics::ComputeConvexConcaveFaceHessian(const Vector6d& a1, const Vector6d& a2, const Vector6d& b1, const Vector6d& b2, double aY, double bY, double cY, double dY, const Vector6d& dSi, const Vector6d& dsi, double gradfS, double gradfs, double HS, double Hs)
{
...
void PenaltyDynamics::prepare_hessian()
{
	int n = numV;
